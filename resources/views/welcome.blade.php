...
<div class="nicdark_right_sidebar nicdark_bg_greydark nicdark_nicescrool">
    ...
    <div class="nicdark_textevidence">
        <div class="nicdark_margin20">
            <ul class="nicdark_list nicdark_relative">
                <li>
                    <a href="single-product.html"><img alt="" class="nicdark_absolute nicdark_radius nicdark_opacity nicdark_width60" src="img\shop\img1.jpg"></a>
                ...
                <li>
                    <a href="single-product.html"><img alt="" class="nicdark_absolute nicdark_radius nicdark_opacity nicdark_width60" src="img\shop\img2.jpg"></a>
                    <div class="nicdark_activity nicdark_marginleft80">
    ...
    <div class="nicdark_margin020">
        ...
        <div class="nicdark_focus">
            <a href="shop-cart.html" class="nicdark_btn nicdark_bg_green small nicdark_shadow nicdark_radius white"><i class="icon-basket-1"></i>&nbsp;&nbsp;VIEW CART</a>
        </div>
    </div>
    <!--end CART-->
    ...
    <div class="nicdark_margin020">
        ...
        <div class="nicdark_space20"></div>
        <a href="shop.html" class="nicdark_btn nicdark_bg_yellow small nicdark_shadow nicdark_radius white"><i class="icon-money-1"></i>&nbsp;&nbsp;FILTER</a>
    </div>
    <!--END FILTER-->
    ...
    <div class="nicdark_textevidence">
        <div class="nicdark_margin20">
            <ul class="nicdark_list nicdark_relative">
                <li>
                    <a href="single-product.html"><img alt="" class="nicdark_absolute nicdark_radius nicdark_opacity nicdark_width60" src="img\shop\img3.jpg"></a>
                    <div class="nicdark_activity nicdark_marginleft80">
                ...
                <li>
                    <a href="single-product.html"><img alt="" class="nicdark_absolute nicdark_radius nicdark_opacity nicdark_width60" src="img\shop\img4.jpg"></a>
                    <div class="nicdark_activity nicdark_marginleft80">
                ...
                <li>
                    <a href="single-product.html"><img alt="" class="nicdark_absolute nicdark_radius nicdark_opacity nicdark_width60" src="img\shop\img5.jpg"></a>
                    <div class="nicdark_activity nicdark_marginleft80">
    ...
    <div class="nicdark_margin20">
        ...
        <div class="nicdark_space20"></div>
        <a href="shop.html" class="nicdark_btn nicdark_bg_blue small nicdark_shadow nicdark_radius white"><i class="icon-search-outline"></i>&nbsp;&nbsp;SEARCH</a>
    </div>
    <!--end SEARCH-->
    ...
    <div class="nicdark_margin10">
        <a href="shop.html" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Teacher</a>
        <a href="shop.html" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Baby</a>
        <a href="shop.html" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Kids</a>
        <a href="shop.html" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Teacher</a>
        <a href="shop.html" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Teacher</a>
        <a href="shop.html" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Baby</a>
        <a href="shop.html" class="nicdark_btn nicdark_bg_greydark2 small nicdark_shadow nicdark_radius white subtitle nicdark_margin10">Kids</a>
                ...
                <div class="grid grid_6 right">
                    <div class="nicdark_focus right">
                        <h6 class="white">
                            ...
                            &nbsp;&nbsp;&nbsp;&nbsp;<span class="grey">·</span>&nbsp;&nbsp;&nbsp;&nbsp;
                            <i class="icon-plus-outline"></i>&nbsp;&nbsp;<a  href="{{ route('register') }}">REGISTER</a>
                            &nbsp;&nbsp;&nbsp;&nbsp;<span class="grey">·</span>&nbsp;&nbsp;&nbsp;&nbsp;
                            <i class="icon-lock-1"></i>&nbsp;&nbsp;<a href="{{ route('login') }}">LOG IN</a>
                        </h6>
                    </div>
                </div>
                    ...
                    <div class="nicdark_margin20">
                        ...
                        <ul class="nicdark_list border">
                            ...
                            <li class="nicdark_border_grey">
                                <p><a class="grey" href="index-1.html">ENGLISH</a><a href="index-1.html" class="nicdark_btn right nicdark_opacity"><img alt="" width="30" src="img\flag\img1.png"></a></p>
                                <div class="nicdark_space15"></div>
                            </li>

                            <li class="nicdark_border_grey">
                                <div class="nicdark_space15"></div>
                                <p><a class="grey" href="index-1.html">BANGLADESH</a><a href="index-1.html" class="nicdark_btn right nicdark_opacity"><img alt="" width="30" src="img\flag\img2.png"></a></p>   
                                <div class="nicdark_space15"></div>
                            </li>
            ...
            <div class="nicdark_container nicdark_clearfix">
                ...
                <div class="grid grid_12 percentage">
                        ...
                        <div class="nicdark_logo nicdark_marginleft10">
                            <a href="index-1.html"><img alt="" src="img\logo.png"></a>
                        </div>
    ...
    <div class="nicdark_container nicdark_clearfix">
        ...
        <div class="grid grid_6">
            ...
            <div class="nicdark_archive1 nicdark_bg_orange nicdark_radius nicdark_shadow">
                ...
                <div class="nicdark_textevidence nicdark_width_percentage40 nicdark_width100_responsive">
                    <img alt="" class="nicdark_radius_left nicdark_opacity" src="img\team\img1.jpg">
                </div>
        ...
        <div class="grid grid_6">
            ...
            <div class="nicdark_archive1 nicdark_bg_blue nicdark_radius nicdark_shadow">
                ...
                <div class="nicdark_textevidence nicdark_width_percentage40 nicdark_width100_responsive">
                    <img alt="" class="nicdark_radius_left nicdark_opacity" src="img\team\img2.jpg">
                </div>
        ...
        <div class="grid grid_6">
            ...
            <div class="nicdark_archive1 nicdark_bg_yellow nicdark_radius nicdark_shadow">
                ...
                <div class="nicdark_textevidence nicdark_width_percentage40 nicdark_width100_responsive">
                    <img alt="" class="nicdark_radius_left nicdark_opacity" src="img\team\img3.jpg">
                </div>
        ...
        <div class="grid grid_6">
            ...
            <div class="nicdark_archive1 nicdark_bg_violet nicdark_radius nicdark_shadow">
                ...
                <div class="nicdark_textevidence nicdark_width_percentage40 nicdark_width100_responsive">
                    <img alt="" class="nicdark_radius_left nicdark_opacity" src="img\team\img4.jpg">
                </div>
